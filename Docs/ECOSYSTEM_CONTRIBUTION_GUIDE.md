...
This guide details how to create and submit third-party **Benchmark Packs**, **Dataset Packs**, **Model Connectors**, and **Evaluation Plugins** for SemantIQ Benchmarks.

---

## 1. Creating a Benchmark Pack
