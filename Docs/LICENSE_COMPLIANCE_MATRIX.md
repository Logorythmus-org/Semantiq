...
This document records license compatibility across code, documentation, baseline datasets, and third-party dependencies in **SemantIQ Benchmarks**.
...
## 2. Copyleft Exclusions

SemantIQ does not incorporate any GPL, AGPL, SSPL, or non-commercial source code dependencies into its baseline distribution.
