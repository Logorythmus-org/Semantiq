...
- Semantic memory for durable concepts and relationships.
- Conversation memory for user-agent dialogue.
- Agent memory for agent-specific learned behavior.
- Research memory for evidence, hypotheses, experiments, and reviews.
- Execution memory for plans, tasks, results, and tool audits.
- Reflection memory for lessons and future improvements.
