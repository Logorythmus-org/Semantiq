...
3. **Canonical Invariant Enforced**:
   - *A subsystem PASS never authorizes product release.* Subsystem status is `INTERNAL GATE PASSED`; product status is `PRE-RELEASE / PUBLIC ALPHA NOT YET AUTHORIZED`.
