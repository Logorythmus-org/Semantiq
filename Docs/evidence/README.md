...
- 🧭 **[Third Canonicalization Migration Selection](THIRD_CANONICALIZATION_MIGRATION_SELECTION.md)** (`PLANNING_ONLY`): Post-second-migration security-control recalibration and the Core run-component family selected for a future Prompt 21; no production hash behavior changes here.
