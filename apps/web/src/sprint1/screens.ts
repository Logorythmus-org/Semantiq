...
export const sprint1ScreenDescriptors = [
  ...
  },
  {
    ...
    primaryAction: "Create question"
  },
  {
    id: "question-editor",
    title: "Question Editor",
    route: "/workspaces/:workspaceId/questions/:questionId",
    primaryAction: "Save question"
  },
  {
    id: "knowledge-editor",
    title: "Knowledge Editor",
    route: "/workspaces/:workspaceId/knowledge/:knowledgeId",
    primaryAction: "Save object"
  },
  {
    id: "graph-viewer",
    title: "Graph Viewer",
    route: "/workspaces/:workspaceId/graph",
    primaryAction: "Filter graph"
  },
  {
    id: "search",
    title: "Search",
  ...
  { id: "settings", title: "Settings", route: "/settings", primaryAction: "Save settings" },
  {
    id: "export",
    title: "Export",
    route: "/workspaces/:workspaceId/export",
    primaryAction: "Export workspace"
  },
