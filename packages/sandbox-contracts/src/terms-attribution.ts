...
export class ComplianceAttributionCompiler {
  private readonly defaultTrademarkDisclaimers: TrademarkDisclaimer[] = [
    {
      ...
      disclaimerText: 'Docker and the Docker logo are trademarks or registered trademarks of Docker, Inc. SemantIQ is an independent evaluation tool with no commercial affiliation.'
    },
    {
      mark: 'Kubernetes',
      owner: 'The Linux Foundation',
      usageContext: 'Cluster orchestration identification',
      disclaimerText: 'Kubernetes is a registered trademark of The Linux Foundation. Used nominatively to refer to execution compatibility.'
    }
  ];
  ...
  compilePackage(
    ...
    const summaryLines: string[] = [
      ...
      commercialTerms.termsOfServiceUrl ? `- **Terms of Service**: ${commercialTerms.termsOfServiceUrl}` : '',
      '',
    ...
    return {
      ...
      summaryMarkdown,
      packageSignatureHex: '3045022100attrpkg0123456789abcdef0123456789abcdef0123456789abcdef0220attrpkg0123456789abcdef0123456789abcdef0123456789abcdef'
    };
  }
