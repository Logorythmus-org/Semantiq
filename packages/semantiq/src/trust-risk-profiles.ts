...
export class TrustRiskProfileEngine {
  evaluateTrustProfile(profile: TrustProfile): ProfileFailureReport | undefined {
    ...
    if (lowerLabel.includes('absolutely trusted') || lowerLabel.includes('100% trustworthy') || lowerLabel.includes('perfect actor')) {
      return {
    ...
    if (lowerLabel.includes('guilty') || lowerLabel.includes('malicious') || lowerLabel.includes('criminal') || lowerLabel.includes('immoral')) {
      return {
