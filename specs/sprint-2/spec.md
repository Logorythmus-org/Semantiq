...
- S2-APPROVAL: Human approval and audit runtime.
- S2-SIM: Similarity and duplicate detection.
- S2-REL: Semantic relation suggestions.
- S2-RES: Research project runtime.
- S2-EVD: Evidence runtime and quality.
- S2-HYP: Hypothesis runtime.
- S2-TASK: Research task planning.
- S2-DASH: Research dashboard.
- S2-AI: Local AI provider contracts and prompt registry.
- S2-API: API, event, schema, and service contracts.
