...
- S3-WFLOW: Workflow runtime.
- S3-AGENT: Agent runtime and registry.
- S3-MEM: Memory runtime.
- S3-TOOL: Tool adapter runtime.
- S3-COLLAB: Multi-agent collaboration.
- S3-REFLECT: Reflection runtime.
- S3-LEARN: Learning runtime.
- S3-APPROVAL: Human approval runtime.
- S3-GRAPH: Knowledge Graph integration.
- S3-API: API/event/schema contracts.
