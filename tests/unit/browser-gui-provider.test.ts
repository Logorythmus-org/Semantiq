...
describe('SemantIQ Sandbox Phase — Browser and GUI Execution Provider', () => {
  ...
  it('normalizes a successful GUI action execution into an observation event', () => {
    ...
    const result: GuiActionResult = {
      ...
      consoleLogs: [
        { type: 'info', text: 'Form submitted', timestamp: '2026-08-15T16:00:00Z' }
      ],
      durationMs: 120
    };
    ...
    expect(event.screenshotSha256).toBe('sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855');
  ...
  it('correctly tracks console errors in normalized GUI events', () => {
    ...
    const result: GuiActionResult = {
      ...
      consoleLogs: [
        { type: 'error', text: 'Uncaught TypeError: Cannot read property', timestamp: '2026-08-15T16:00:00Z' },
