...
describe('SemantIQ Sandbox Phase — Canonical Provider Registry', () => {
  ...
  const sampleLocalEntry: CanonicalProviderRegistryEntry = {
    ...
    signatureHex: '3045022100regentry0123456789abcdef0123456789abcdef0123456789abcdef0220regentry0123456789abcdef0123456789abcdef0123456789abcdef'
  };
  ...
  const sampleCloudEntry: CanonicalProviderRegistryEntry = {
    ...
    registeredAt: '2026-08-15T12:00:00Z',
    lastHeartbeatAt: '2026-08-15T12:00:00Z',
    signatureHex: '3045022100e2breg0123456789abcdef0123456789abcdef0123456789abcdef0220e2breg0123456789abcdef0123456789abcdef0123456789abcdef'
  };
  ...
  it('updates operational health status and emits STATUS_CHANGED event', () => {
    ...
    const events = registry.getEventLog();
    expect(events.some(e => e.eventType === 'STATUS_CHANGED' && e.currentStatus === 'DEGRADED')).toBe(true);
  });
