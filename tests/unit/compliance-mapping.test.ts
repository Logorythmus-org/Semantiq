...
import type { EvidenceMapping, FrameworkVersion } from '../../packages/semantiq/src/compliance-mapping.js';
...
describe('Compliance Mapping Framework (Prompt 10.7)', () => {
  ...
  const validMapping: EvidenceMapping = {
    mappingId: 'map_101',
    requirementId: 'AC-2',
    evidenceChecksum: { uri: 'file:///tmp/audit_log.json', algorithm: 'sha256', hash: 'abc123hash' },
