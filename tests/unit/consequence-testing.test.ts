...
describe('SemantIQ Sandbox Phase — Consequence Testing Architecture', () => {
  ...
  it('evaluates recognition, accurate root cause attribution, and surgical remediation', () => {
    ...
    const report = engine.evaluateConsequenceTelemetry('scenario-billing-refactor', 'agent-systemic', specs, traceEvents);
  ...
  it('penalizes blind secondary cascades when agent fails to attribute root cause', () => {
    ...
    const report = engine.evaluateConsequenceTelemetry('scenario-billing-refactor', 'agent-blind', specs, blindTrace);
  ...
  it('exports formatted Markdown consequence evaluation report', () => {
    const report = engine.evaluateConsequenceTelemetry('scenario-billing-refactor', 'agent-systemic', specs, []);
