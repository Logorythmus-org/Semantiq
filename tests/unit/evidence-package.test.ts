...
describe("SemantIQ Sandbox Phase — Portable Evidence Package", () => {
  ...
  const behavioralTrace: BehavioralTraceEvent[] = [
    ...
    createTraceEvent(1, "INTERPRETATION", undefined, {
      hypothesis: "Null check missing in save()"
    }),
    ...
    createTraceEvent(6, "RECOVERY", "REVISE_DIFF", {
      retryCount: 1,
      action: "add_exception_handler"
    })
  ];
  ...
  const receipt = receiptIssuer.issueReceipt({
    ...
    provenance: {
      ...
      runtimeType: "container",
      environmentSpecHash:
        "sha256:ba822f60cf6ae44304d8f1618793ed09ac3cb6bc8b5368d653c0b8dc7c2f0ad0",
    ...
    artifacts: {
      filesMerkleRoot:
        "sha256:merkle1111222233334444555566667777888899990000aaaabbbbccccddddeeeeffff",
      evidenceBundleDigest:
        "sha256:evidence1111222233334444555566667777888899990000aaaabbbbccccddddeeeeffff",
      artifacts
    },
    observation: {
      behavioralChainHash:
        "sha256:chain1111222233334444555566667777888899990000aaaabbbbccccddddeeeeffff",
    ...
    financial: {
      costLedgerDigest:
        "sha256:cost1111222233334444555566667777888899990000aaaabbbbccccddddeeeeffff",
      totalGrossCostUsd: costLedger.totalGrossCostUsd,
      totalNetCostUsd: costLedger.totalNetCostUsd,
      currency: "USD"
    },
    compliance: {
      compliancePackageDigest:
        "sha256:comp1111222233334444555566667777888899990000aaaabbbbccccddddeeeeffff",
      complianceGrade: "COMPLIANT_WITH_NOTICES"
    },
    issuerPublicKeyHex:
      "04abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"
  });
  ...
  it("validates pristine evidence package and flags recovery warnings without errors", () => {
    ...
    expect(
      result.warnings.some((w) => w.includes("Behavioral trace contains recovery events"))
    ).toBe(true);
  });
