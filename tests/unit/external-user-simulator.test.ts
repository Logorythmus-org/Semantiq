...
describe('External User and Fresh-Clone Simulation (Prompt 11.12)', () => {
  ...
  const standardSteps: OnboardingStep[] = [
    { stepName: 'Inspect Root', commandOrAction: 'ls -la', expectedOutcome: 'Clean directory structure', status: 'SUCCESS' },
    { stepName: 'Read README', commandOrAction: 'cat README.md', expectedOutcome: 'Clear instructions', status: 'SUCCESS' },
    { stepName: 'Install', commandOrAction: 'pnpm install', expectedOutcome: 'Dependencies installed', status: 'SUCCESS' },
    { stepName: 'Run Doctor', commandOrAction: 'semantiq doctor', expectedOutcome: 'System healthy', status: 'SUCCESS' },
    { stepName: 'Run Smoke', commandOrAction: 'semantiq smoke', expectedOutcome: 'Quick check passed', status: 'SUCCESS' },
    { stepName: 'Run Benchmark', commandOrAction: 'semantiq benchmark', expectedOutcome: 'Scores calculated', status: 'SUCCESS' },
    { stepName: 'Replay Evidence', commandOrAction: 'semantiq replay', expectedOutcome: 'Replay match 100%', status: 'SUCCESS' }
  ];
