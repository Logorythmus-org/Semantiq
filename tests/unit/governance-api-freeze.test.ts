...
describe('Governance API and Contract Freeze (Prompt 10.11)', () => {
  ...
  const validCatalog: GovernancePublicApiCatalog = {
    ...
    entries: [
      { exportName: 'PolicyEvidenceEngine', category: 'policy', version: 'v1.0.0', stability: 'stable' },
      { exportName: 'PolicyApplicabilityEngine', category: 'applicability', version: 'v1.0.0', stability: 'stable' },
      { exportName: 'HumanApprovalEngine', category: 'approval', version: 'v1.0.0', stability: 'stable' },
      { exportName: 'GovernanceDecisionEngine', category: 'decision', version: 'v1.0.0', stability: 'stable' },
      { exportName: 'GovernanceIncidentAuditEngine', category: 'audit', version: 'v1.0.0', stability: 'stable' },
      { exportName: 'ComplianceMappingEngine', category: 'mapping', version: 'v1.0.0', stability: 'stable' },
      { exportName: 'TrustRiskProfileEngine', category: 'profile', version: 'v1.0.0', stability: 'stable' }
    ],
  ...
  it('detects unversioned export', () => {
    const unversCatalog: GovernancePublicApiCatalog = {
      ...validCatalog,
      entries: [
        { exportName: 'UnversionedEngine', category: 'policy', version: '', stability: 'experimental' }
      ]
    };
  ...
  it('detects enforcement semantics leaked into API export name', () => {
    const enfCatalog: GovernancePublicApiCatalog = {
      ...validCatalog,
      entries: [
        { exportName: 'AutonomousPolicyEnforcer', category: 'policy', version: 'v1.0.0', stability: 'stable' }
      ]
    };
  ...
  it('detects certification semantics leaked into API export name', () => {
    const certCatalog: GovernancePublicApiCatalog = {
      ...validCatalog,
      entries: [
        { exportName: 'ComplianceCertifierGuarantee', category: 'mapping', version: 'v1.0.0', stability: 'stable' }
      ]
    };
