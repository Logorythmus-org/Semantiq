...
describe('Negotiation and Consensus Observation (Prompt 9.6)', () => {
  ...
  it('evaluates unanimous agreement cleanly', () => {
    const session: NegotiationSession = {
      ...
      votes: [
        { proposalId: 'prop_001', agentId: 'agent_a', vote: 'approve', timestamp: '2026-08-01T14:00:00Z' },
        { proposalId: 'prop_001', agentId: 'agent_b', vote: 'approve', timestamp: '2026-08-01T14:00:01Z' }
      ],
      status: 'agreed'
    };
  ...
  it('detects veto and terminates consensus with vetoed outcome', () => {
    const vetoSession: NegotiationSession = {
      ...
      eligibleAgentIds: ['agent_a', 'agent_b'],
      votes: [
        { proposalId: 'prop_002', agentId: 'agent_a', vote: 'approve', timestamp: '2026-08-01T14:00:00Z' },
        { proposalId: 'prop_002', agentId: 'agent_b', vote: 'veto', timestamp: '2026-08-01T14:00:01Z' }
      ],
      status: 'vetoed'
    };
  ...
  it('detects deadlock when votes are tied without resolution', () => {
    const deadlockSession: NegotiationSession = {
      ...
      eligibleAgentIds: ['agent_a', 'agent_b'],
      votes: [
        { proposalId: 'prop_003', agentId: 'agent_a', vote: 'approve', timestamp: '2026-08-01T14:00:00Z' },
        { proposalId: 'prop_003', agentId: 'agent_b', vote: 'reject', timestamp: '2026-08-01T14:00:01Z' }
      ],
      status: 'deadlocked'
    };
