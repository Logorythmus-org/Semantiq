...
describe("SemantIQ Sandbox Phase — Provider Marketplace Architecture", () => {
  ...
  const localDockerListing: ProviderMarketplaceListing = {
    ...
    signatureHex:
      "3045022100e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b85502202b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
  };
  ...
  const cloudMicroVmListing: ProviderMarketplaceListing = {
    ...
    publishedAt: "2026-08-15T12:00:00Z",
    signatureHex:
      "3045022100aabbccddeeff00112233445566778899aabbccddeeff001122334455667788990220aabbccddeeff00112233445566778899aabbccddeeff00112233445566778899"
  };
  ...
  const enterpriseAirgapListing: ProviderMarketplaceListing = {
    ...
    publishedAt: "2026-08-15T12:00:00Z",
    signatureHex:
      "3045022100112233445566778899aabbccddeeff00112233445566778899aabbccddeeff0220112233445566778899aabbccddeeff00112233445566778899aabbccddeeff"
  };
  ...
  it("rejects listings with invalid signatures or non-isolated extensions", () => {
    ...
    expect(audit.violations).toContain(
      "Marketplace listing cryptographic signature is missing or malformed."
    );
    expect(audit.violations).toContain(
      "Extensions must be isolated from canonical benchmark semantics."
    );
  });
  ...
  it("filters listings by deployment mode and offline requirement", () => {
    ...
    expect(
      offlineResult.rankedCandidates.some((c) => c.listing.listingId === "listing-e2b-cloud")
    ).toBe(false);
  ...
  it("filters listings by security grade and hardware microVM capability", () => {
    ...
    expect(
      microVmResult.rankedCandidates.some((c) => c.listing.listingId === "listing-local-docker")
    ).toBe(false);
  });
