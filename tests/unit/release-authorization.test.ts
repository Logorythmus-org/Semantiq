...
} from "../../packages/semantiq/src/release-authorization.js";
...
describe("Phase 11.5.10 — Phase 12 Release Authorization", () => {
  ...
  const passedGates: GateSuiteEvaluation = {
    gateA_scientificHonesty: {
      gateId: "gate-a",
      gateName: "Scientific Honesty",
      isPassed: true,
      evidenceReference: "PHASE_11_5_2_COMPLETION_REPORT.md"
    },
    gateB_reproducibility: {
      gateId: "gate-b",
      gateName: "Reproducibility",
      isPassed: true,
      evidenceReference: "PHASE_11_14_COMPLETION_REPORT.md"
    },
    gateC_contestability: {
      gateId: "gate-c",
      gateName: "Contestability",
      isPassed: true,
      evidenceReference: "PHASE_11_5_6_COMPLETION_REPORT.md"
    },
    gateD_humanResponsibility: {
      gateId: "gate-d",
      gateName: "Human Responsibility",
      isPassed: true,
      evidenceReference: "PHASE_11_5_3_COMPLETION_REPORT.md"
    },
    gateE_antiGaming: {
      gateId: "gate-e",
      gateName: "Anti-Gaming",
      isPassed: true,
      evidenceReference: "PHASE_11_5_4_COMPLETION_REPORT.md"
    },
    gateF_communityLegitimacy: {
      gateId: "gate-f",
      gateName: "Community Legitimacy",
      isPassed: true,
      evidenceReference: "PHASE_11_5_7_COMPLETION_REPORT.md"
    },
    gateG_correctionCapability: {
      gateId: "gate-g",
      gateName: "Correction Capability",
      isPassed: true,
      evidenceReference: "PHASE_11_5_6_COMPLETION_REPORT.md"
    },
    gateH_selfObservation: {
      gateId: "gate-h",
      gateName: "Self-Observation",
      isPassed: true,
      evidenceReference: "PHASE_11_5_8_COMPLETION_REPORT.md"
    }
  };
