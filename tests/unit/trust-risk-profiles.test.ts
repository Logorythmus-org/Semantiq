...
describe("Trust and Risk Profiles (Prompt 10.8)", () => {
  ...
  const validProfile: TrustProfile = {
    ...
    dimensions: [
      {
        ...
        explanation: {
          explanationId: "exp_1",
          summary: "Consistently adhered to data policies",
          rationale: "No policy violations observed in window"
        }
      },
      {
        ...
        explanation: {
          explanationId: "exp_2",
          summary: "Obtained required approvals",
          rationale: "All privileged actions backed by human approvals"
        }
      }
    ],
    ...
    evidence: [
      {
        evidenceId: "ev_1",
        checksum: { uri: "file:///tmp/audit.json", algorithm: "sha256", hash: "hash1" },
        description: "Audit log digest"
      }
    ],
